...
public class Main {
    ...
    public static class Thief implements MailService {
        ...
        private static final String STONES_CONTENT = "stones instead of %s";
        ...
        public Sendable processMail(Sendable mail) {
            if (mail instanceof MailPackage) {
                ...
                if (content.getPrice() >= minPrice) {
                    ...
                    Package stones = new Package(String.format(STONES_CONTENT, content.getContent()), EMPTY_PRICE);
    ...
    public static class Inspector implements MailService {
        ...
        public Sendable processMail(Sendable mail) {
            if (mail instanceof MailPackage) {
                String mailPackageContent = ((MailPackage) mail).getContent().getContent();
                if (mailPackageContent.contains(WEAPONS) || mailPackageContent.contains(BANNED_SUBSTANCE)) {
                    throw new IllegalPackageException();
                }

                if (mailPackageContent.contains("stones")) {
